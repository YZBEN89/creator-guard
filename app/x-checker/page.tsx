...
import {
  reviewXContent,
  type XPlatformReview,
} from "@/lib/platform/x";

export default function XCheckerPage() {
  const [text, setText] = useState("");
  const [result, setResult] =
    useState<AnalysisResult | null>(null);

  const platformReview: XPlatformReview | null =
    result
      ? reviewXContent({
          risk: result.risk,
          score: result.score,
  ...
  if (result) {
    if (result.risk === "High") {
      publishSuggestions.push(
        "Review or remove the high-risk portion before posting."
      );
    }
    ...
    <main className="min-h-screen bg-white text-zinc-900">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-10 pt-16 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-zinc-600">
          Check posts, threads, and promotional
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20">
        <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <textarea
            ...
            maxLength={10000}
            rows={12}
            placeholder="Paste your X post, thread, or promotional content here..."
          ...
          <div className="mt-8 space-y-6">
            ...
            <section className="rounded-3xl border border-amber-200 bg-amber-50 p-6 sm:p-8">
              ...
              <p className="mt-3 text-sm leading-6 text-amber-800">
                ...
                monetization, or advertising decisions of X
