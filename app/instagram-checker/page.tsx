...
import {
  reviewInstagramContent,
  type InstagramPlatformReview,
...
export default function InstagramCheckerPage() {
  ...
  const platformReview: InstagramPlatformReview | null =
    result
      ? reviewInstagramContent({
          risk: result.risk,
          score: result.score,
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20">
        <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <textarea
            ...
            maxLength={10000}
            rows={12}
            placeholder="Paste your Instagram caption, script, or promotional content here..."
