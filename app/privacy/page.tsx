      ...
      <article className="mx-auto max-w-4xl px-6 py-14">
        ...
        <div className="mt-12 space-y-10 text-base leading-8 text-zinc-700">
          ...
          <section>
            ...
            <p className="mt-4">
              Depending on the services enabled, this information may include:
            </p>
            ...
            <ul className="mt-5 space-y-3 pl-5">
              ...
              <li className="list-disc">
                operating system and technical configuration;
              </li>
              ...
              <li className="list-disc">
                approximate date and time of access; and
              </li>

              <li className="list-disc">
                diagnostic, performance, security, or error information.
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight">
              8. Consent and European Privacy Requirements
            </h2>
          ...
          <section>
            ...
            <ul className="mt-5 space-y-3 pl-5">
              ...
              <li className="list-disc">
                processing requests made through the website;
              </li>
              ...
              <li className="list-disc">
                preventing fraud, abuse, attacks, and other security threats;
              </li>

              <li className="list-disc">
                understanding general website usage and improving the user
                experience;
              </li>
              ...
              <li className="list-disc">
                serving and measuring advertising when advertising services are
                enabled.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              process, governmental request, or when reasonably necessary to
              protect our rights, users, services, or property.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              for the purposes described in this Privacy Policy, for security
              and operational purposes, or as required by applicable law.
            </p>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              access, alteration, disclosure, misuse, or destruction.
            </p>

            <p className="mt-4">
              However, no website, network transmission, or electronic storage
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              to support appropriate safeguards for international data
              transfers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              request access, correction, deletion, restriction, or other
              available privacy rights.
            </p>

            <p className="mt-4">
              You may also have choices regarding cookies, advertising
              personalization, analytics, or consent depending on the tools
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight">
              17. California and U.S. Privacy Rights
            </h2>
          ...
          <section>
            ...
            <p className="mt-4">
              Users may also have the right to lodge a complaint with a
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              changes to the website, services, technology, advertising
              partners, analytics tools, or applicable legal requirements.
            </p>

            <p className="mt-4">
              The “Last updated” date at the top of this page indicates when the
