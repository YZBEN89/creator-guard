      ...
      <section className="mx-auto max-w-4xl px-6 py-12">
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <textarea
            ...
            maxLength={20000}
            placeholder="Paste your video script, voice-over draft, hook, or long-form spoken content here..."
            className="mt-4 min-h-[360px] w-full resize-y rounded-xl border border-zinc-300 bg-zinc-50 p-4 text-sm leading-6 outline-none transition focus:border-black focus:bg-white"
          />
          ...
          <div className="mt-3 flex items-center justify-between text-xs text-zinc-500">
            ...
            <span>Long-form scripts supported</span>
          </div>
          ...
          <div className="mt-10 space-y-6">
            ...
            {result.optimizationMatches.length > 0 && (
              <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-500">
                  ...
                  risks, but improving them may make your script clearer
                  and more credible.
                </p>
            ...
            <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-zinc-600">
                ...
                <li>
                  • Avoid unnecessary urgency or pressure in promotional
                ...
                <li>
                  • Review the full script context rather than relying
                  only on individual keywords.
                </li>
              </ul>
            </section>
            ...
            <section className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600">
                ...
                moderation, monetization, advertising, or other
                platform decisions of any platform.
              </p>
            </section>
          </div>
        )}
